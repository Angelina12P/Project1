...
console.log(queryTerm)
  ...
  let bookImage = `assets/images/No Book Image.png`;
...
<img src="${bookImage}" class="rounded mx-auto d-block" onerror="this.onerror=null;this.src='assets/images/No Book Image.png';"
</div>`;
